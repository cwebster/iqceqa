...
class TargetsControllerTest < ActionController::TestCase
  ...
  test "should create target" do
    assert_difference('Target.count') do
      post :create, target: { IQCID: @target.IQCID, dateTimeValid: @target.dateTimeValid, notes: @target.notes, testCode: @target.testCode }
    end
  ...
  test "should update target" do
    put :update, id: @target, target: { IQCID: @target.IQCID, dateTimeValid: @target.dateTimeValid, notes: @target.notes, testCode: @target.testCode }
    assert_redirected_to target_path(assigns(:target))
  end
